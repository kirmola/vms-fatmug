...
class Vendor(models.Model):
    ...
    vendor_code = models.CharField(_("Vendor's Unique Identifier"), max_length=50, primary_key=True)
    ...
    quality_rating_avg = models.FloatField(_("Quality Rating"), validators=[
        MinValueValidator(limit_value=1),   # Rating goes between 1 to 5 
        MaxValueValidator(limit_value=5),   # Rating goes between 1 to 5
    ])
    average_response_time = models.FloatField(_("Average Response time of vendor"))
...
class PurchaseOrder(models.Model):
    ...
    status = models.CharField(_("Order Status"), choices=ORDER_STATUS, max_length=50)
    quality_rating = models.FloatField(_("Quality Rating of Order"), default=None, validators=[
        MinValueValidator(limit_value=1), 
        MaxValueValidator(limit_value=5),
    ])
    issue_date = models.DateTimeField(_("Order Issue Date to the Vendor"), default=None)
    acknowledgement_date = models.DateTimeField(_("Order Acknowledgment Date"), default=None)
